        ...
        <table className="w-full border-collapse border border-gray-300">
          <thead>
            <tr className="bg-[#e3ce27] text-white">
              ...
              <th className="border border-gray-300 px-4 py-2 text-left">Student Age</th>
          ...
          <tbody>
            {students.map((student, index) => (
              <tr key={index} className="odd:bg-white">
                ...
                <td className="border border-gray-300 px-4 py-2">{student.schoolId.name}</td>
                <td className="border border-gray-300 px-4 py-2">{student.classId.name}</td>
              </tr>
            ))}
          </tbody>
        </table>
